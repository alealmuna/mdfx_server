...
mdfx_client: protoc_interfaces_middleman src/client.cc proto_handler.o
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) src/protobuf/interfaces.pb.cc src/client.cc proto_handler.o -o bin/$@ \
